...
async def reedme(e):
    await e.edit(
        ...
        "\n[OpenUserBot's README.md file](https://github.com/kevxng/userbot/blob/sql-extended/README.md)"
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "Click [HERE](https://github.com/kevxng/userbot) to open kevxnguserbot's GitHub page."
    )
